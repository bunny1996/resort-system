...
int DisRow1=0;
		...
		&nbsp;&nbsp;<A onclick='fnEmpPopUp("EditUserProfile.jsp?UserID=<%=UserID%>",600,600)'><IMG SRC="Images/Update.jpg" WIDTH="104" HEIGHT="26" BORDER="0" ALT=""></A>
		 ...
		 <td align=Left style="background-color:#F8EDD6"><font  color="black"><P align=left><%=MemberType%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A onclick='fnEmpPopUp("UpgradeMemberType.jsp?UserID=<%=UserID%>&MemberType=<%=MemberType%>",600,600)'><IMG SRC="Images/Upgrade.jpg" WIDTH="106" HEIGHT="26" BORDER="0" ALT=""></A>
		</font></td></tr>
