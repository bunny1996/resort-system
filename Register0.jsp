...
<script LANGUAGE="Javascript" SRC="">
		...
		{		var frm = document.forms(0);
				...
				if(ChkMandatoryField(frm.CreditCardNumber,'CreditCardNumber ')==false) return false;
...
<TR class="row_title">
	<Td align=center> New User Details<BR></Td>
		...
		<FONT COLOR="red">*</TH>
		<TD class=row_odd>&nbsp;&nbsp;<Input type="text"  name='AmountDeposited' value='' >
		<TR class=row_even><TH align="left">Credit Card Number
		<FONT COLOR="red">*</TH>
		<TD class=row_odd>&nbsp;&nbsp;<Input type="text"  name='Credit card Number' value=''>
		</TR>
		</TR>
	        <TR>
